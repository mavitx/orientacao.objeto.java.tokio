...
public class Caminhao {
	...
	String marca, modelo, cor, tipoCambio, tipoCarga, nomeCondutor;
	Date anoFabricacao = new Date(); 
	Date anoModelo = new Date();
	int renavam, motor, eixos, limiteVeloc;
	double aroRodas, velocidade, limiteCarga, qtdCarga;
	boolean ligado;
	...
	public void carregar(double valor) {
		qtdCarga += valor;
		if(qtdCarga > limiteCarga) {
			qtdCarga = limiteCarga;
		}
	}
	...
	public void exibir() {
		...
		System.out.println("Limite da Carga: " + this.limiteCarga);
		System.out.println("Quantidade da Carga: " + this.qtdCarga);
	}
